Python-S: Created 8/25/2026

Open PS_tutorial.txt, or read this:

Python-S is a python extentsion supporting syntax such as X++, and X--. Python-S is directly transpiled to python
...
The code will be transpiled into PS_EXECUTE.py.
